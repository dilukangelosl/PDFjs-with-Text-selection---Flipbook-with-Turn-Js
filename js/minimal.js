...
window.onload = function () {
	...
	//book height and width

    var bookheight = 0 ;
    var bookwidth = 0;

    var scale = 0.7; //Set this to whatever you want. This is basically the "zoom" factor for 
    ...
    function renderPdf(pdf) {
        ...
        pdf.getPage(i+1).then(function(p, i){
            renderPage(p);
        });
...
console.log(bookheight + " " + bookwidth);
        ...
        page.getTextContent().then(function (textContent) {
            ...
            element = $("<div />").html($pdfContainer);
$("#flipbook").turn("addPage", element, num);
        });
    }
